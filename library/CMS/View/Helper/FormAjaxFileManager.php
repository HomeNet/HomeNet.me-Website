 ...
 */
class CMS_View_Helper_FormAjaxFileManager extends CMS_View_Helper_FormAjaxElement {

    public function formAjaxFileManager($name, $value = null, $attribs = null, $params = null, $options = null) {
