 ...
 */
class HomeNet_Form_SubdeviceModels extends CMS_Form {
    ...
    public function init() {
        ...
        $driver->setValue('HomeNet_Model_Subdevice_Generic');
...
//        $this->addElement($color);
        ...
        $this->addDisplayGroup($this->getElements(), 'room', array('legend' => 'Subdevice Model'));
    }
