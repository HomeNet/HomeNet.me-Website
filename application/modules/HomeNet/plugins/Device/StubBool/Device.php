 ...
 */
class HomeNet_Plugin_Device_StubBool_Device extends HomeNet_Model_Device_Abstract {
    ...
    public function generateCustomCode(){
        return 'class  HomeNetDevice'.$this->getDeviceDriver().' : public HomeNetDeviceStubBool {
public:
    HomeNetDevice'.$this->getDeviceDriver().'(HomeNet& homeNet ):HomeNetDeviceStubBool(homeNet) { };
