 ...
 */
class HomeNet_Model_NetworkType_Service {
    ...
    public function getMapper() {
        ...
        if (empty($this->_mapper)) {
            $this->_mapper = new HomeNet_Model_NetworkType_MapperDbTable();
        }
     ...
     * Set storage mapper
     * 
     * @param HomeNet_Model_NetworkType_MapperInterface $mapper 
     */
     ...
     * 
     * @param int $id
     * @return HomeNet_Model_NetworkType (HomeNet_Model_NetworkType_Interface)
     ...
     * @return HomeNet_Model_Message (HomeNet_Model_NetworkType_Interface)
     * @throws InvalidArgumentException 
     */
    public function create($mixed) {
        if ($mixed instanceof HomeNet_Model_NetworkType_Interface) {
            $object = $mixed;
        } elseif (is_array($mixed)) {
            $object = new HomeNet_Model_NetworkType(array('data' => $mixed));
        } else {
     ...
     * 
     * @param HomeNet_Model_NetworkType_Interface|array $mixed
     * @return HomeNet_Model_NetworkType (HomeNet_Model_NetworkType_Interface)
     * @throws InvalidArgumentException 
     */
     ...
     * Delete a NodeModel
     * 
     * @param HomeNet_Model_NetworkType_Interface|array|integer $mixed
