...
class Core_Model_Route_Service {
    ...
    /**
     * @param Core_Model_Route_Interface|array $mixed
     * @return Core_Model_Route
     * @throws InvalidArgumentException 
     */
    public function create($mixed) {
        if ($mixed instanceof Core_Model_Route_Interface) {
            $object = $mixed;
        } elseif (is_array($mixed)) {
            $object = new Core_Model_Route(array('data' => $mixed));
        } else {
    ...
    /**
     * @param Core_Model_Route_Interface|array|integer $mixed
    ...
    public function delete($mixed) {
        if (is_int($mixed)) {
            ...
            $object->id = $mixed;
        } elseif ($mixed instanceof Core_Model_Route_Interface) {
            $object = $mixed;
        } elseif (is_array($mixed)) {
            $object = new Core_Model_Route(array('data' => $mixed));
        } else {
