...
class Admin_UserPermissionController extends Zend_Controller_Action
{
    ...
    public function init()
    {
     ...
     private function _setupCrumbs($id = null){
    ...
    public function indexAction() {
        ...
        $this->view->objects = $service->getObjectsByGroup($this->_id);
    }
    ...
    public function deleteAction() {
        ...
        $cService = new Core_Model_Acl_Group_Service();
