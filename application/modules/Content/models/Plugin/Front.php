 ...
 */
class Content_Model_Plugin_Front extends Zend_Controller_Plugin_Abstract {
    ...
    public function routeShutdown(Zend_Controller_Request_Abstract $request) {
        ...
        if(strtolower($request->getModuleName()) != 'content'){
            return;
        }
        
        if(!is_null($request->getParam('section'))){
            $this->_proxy = true;
        
            $request->setControllerName($request->getParam('section'));
            
            if(!is_null($request->getParam('template'))){
            
            $request->setActionName($request->getParam('template'));
            }
            
            $this->_params['section']  = $request->getControllerName();
            $this->_params['template']  = $request->getActionName();
