...
//    }
    ...
    public function save(Content_Model_Category_Interface $object) {

        if (($object instanceof Content_Model_Category_DbTableRow) && ($object->isConnected())) {
            return $object->save();
    ...
    public function delete(Content_Model_Category_Interface $object) {
