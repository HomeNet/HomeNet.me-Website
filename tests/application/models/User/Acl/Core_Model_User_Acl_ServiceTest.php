...
/**
 * Test class for Core_Model_User_Acl_Acl_Service.
 * Generated by PHPUnit on 2011-06-22 at 08:07:56.
 */
class Core_Model_User_Acl_ServiceTest extends PHPUnit_Framework_TestCase {

   /**
     * @var Core_Model_User_Acl_Service
     */
    protected $object;
    ...
    protected function setUp() {
        $this->object = new Core_Model_User_Acl_Service();
    }
    ...
    public function testGetMapper() {
        ...
        $this->assertInstanceOf('Core_Model_User_Acl_MapperInterface', $this->object->getMapper());
    }
    ...
    public function testSetMapper() {
        ...
        $mapper = new Core_Model_User_Acl_MapperDbTable();
    ...
    private function createValidUserAcl() {
        $userAcl = new Core_Model_User_Acl();
        $userAcl->user = 1;
        $userAcl->module = 'core';
        ...
        $this->assertInstanceOf('Core_Model_User_Acl_Interface', $result);
        return $result;
    }
