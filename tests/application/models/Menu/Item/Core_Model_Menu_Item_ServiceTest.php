...
class Core_Model_Menu_Item_ServiceTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        $this->object = new Content_Model_Menu_Item_Service;
    }
    ...
    public function testGetMapper() {
        ...
        $this->assertInstanceOf('Content_Model_Menu_Item_MapperInterface', $this->object->getMapper());
    }
    ...
    public function testSetMapper() {
        ...
        $mapper = new Content_Model_Menu_Item_MapperDbTable();
    ...
    private function createValidMenu_Item() {
        $category = new Content_Model_Menu_Item();
        $category->set = 0;
        $category->parent = 1;
        $category->order = 2;
        ...
        $this->assertInstanceOf('Content_Model_Menu_Item_Interface', $result);
        return $result;
    }
...
//    
    public function testDuplicateUrl() {
        ...
        $category1 = $this->createValidMenu_Item();
        $this->setExpectedException('DuplicateEntryException');
        $category2 = $this->createValidMenu_Item();
    }
    ...
    public function testGetObjectById() {
        ...
        //setup
        $category = $this->createValidMenu_Item();
