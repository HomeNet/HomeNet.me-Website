...
class Content_Model_Content_ServiceTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetMapper() {
        ...
        $this->assertInstanceOf('Content_Model_Content_MapperInterface', $this->service->getMapper());
    }
...
//
//        //test getObject
//        $result = $this->service->getObjectsBySectionCategory($content->section, $content->category);
//        
//        $this->assertInstanceOf('Content_Model_Content_Interface', $result);
//
//        $this->assertNotNull($result->id);
...
//        $this->service->deleteAll();
    ...
    public function testAddCustomTable() {
        ...
        $section = 5;
        $this->service->addCustomTable($section);
    }
    ...
    public function testAddCustomField() {
        ...
        $this->service->addCustomField($field);
...
//        $this->service->addCustomField($field);
    ...
    public function testRemoveCustomField() {
        ...
        $this->service->removeCustomField($field);
    }

    public function testRemoveCustomTable() {
        $section = 5;
        $this->service->removeCustomTable($section);
    }
