...
/**
 * Test class for Content_CategoryController.
 * Generated by PHPUnit on 2011-11-19 at 15:55:05.
 */
class Content_CategoryControllerTest extends Zend_Test_PHPUnit_ControllerTestCase {
    ...
    private function createValidObject() {
        ...
        $category->set = $this->contentInstaller->categorySet->test->id;
        $category->parent = 1;
        $category->order = 2;
    ...
    public function testNewAction_submitValid() {
        ...
        $this->getRequest()->setMethod('POST')
          ...
          //  'order' => 0,
            'url' => 'test_url',
            'title' => 'test Title rertetet',
            'description' => 'test Description retetete'));
